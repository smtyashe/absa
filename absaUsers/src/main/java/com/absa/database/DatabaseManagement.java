...
public class DatabaseManagement {
	...
	public Object getEntityData(Class<?> entityClassName, String filtering) {
		if(filtering==null || filtering.isEmpty())
		{
		return retrieve("Select u from " + entityClassName);
		}
		return retrieve("Select u from " + entityClassName + " u where "+filtering);
	}
}
